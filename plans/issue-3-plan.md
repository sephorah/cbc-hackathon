...
<string>OnCallHelper reads your sleep duration from Apple Health to detect sleep deficits that may compound on-call stress. This data never leaves your device.</string>

<key>NSHealthUpdateUsageDescription</key>
<string>OnCallHelper does not write health data. This permission is required by HealthKit but will not be used.</string>
```
